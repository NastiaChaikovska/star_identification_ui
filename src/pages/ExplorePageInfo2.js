...
function ExplorePageInfo2() {
    ...
    // Function to close the star information overlay
            ...
            {selectedStar && (
                <div className="star-info">
                    <div className="star-info-header">
                        ...
                        {/*<Close className="star-info-close" onClick={closeStarInfo} />*/}
...
export default ExplorePageInfo2;
